...
for message in read_ros2_messages(BAG_PATH):
    t = message.log_time.timestamp()
    ...
    if topic == "/odom":
        ...
        filt["cov_x"].append(msg.pose.covariance[0])
        filt["cov_y"].append(msg.pose.covariance[7])
        filt["cov_yaw"].append(msg.pose.covariance[35])
